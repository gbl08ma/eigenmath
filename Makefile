...
MKG3AFLAGS := -s -n basic:Eigenmath -n internal:EIGEN -i uns:../unselected.bmp -i sel:../selected.bmp -i mon:../monoicon.eActIcon

CFLAGS	= -std=c++11 -Os -flto -fno-exceptions -Wall -Wno-write-strings $(MACHDEP) $(INCLUDE) -DPRIZM -D__GIT_VERSION=\"$(GIT_VERSION)\" -D__GIT_TIMESTAMP=\"$(GIT_TIMESTAMP)\"
CXXFLAGS	=	$(CFLAGS)
